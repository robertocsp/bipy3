...
urlpatterns = [
    ...
    url(r'^marviin/api/rest/pedido/(?P<uid>[0-9]+)/chat[/]?$', views.PedidoChatView.as_view(), name='enviar_pedido_view'),
    ...
    url(r'^marviin/api/rest/page_access_token[/]?$', views.PageAccessTokenView.as_view(), name='page_access_token_view'),
